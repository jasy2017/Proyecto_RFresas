...
Option<iarf_e> sp_cpp_lambda_paren = {
  "sp_cpp_lambda_paren",
  u8R"__(
...
Option<iarf_e> sp_type_question = {
  "sp_type_question",
  u8R"__(
...
Option<iarf_e> sp_before_tr_emb_cmt = {
...
BoundedOption<unsigned, 0, 16> sp_num_before_tr_emb_cmt = {
...
BoundedOption<unsigned, 0, 16> indent_sing_line_comments = {
...
BoundedOption<unsigned, 0, 2> indent_paren_close = {
  "indent_paren_close",
  u8R"__(
...
Option<bool> indent_comma_paren = {
  "indent_comma_paren",
  u8R"__(
...
BoundedOption<unsigned, 0, 16> nl_func_var_def_blk = {
  "nl_func_var_def_blk",
  u8R"__(
...
Option<bool> mod_full_brace_if_chain = {
...
BoundedOption<unsigned, 0, 50> mod_add_long_function_closebrace_comment = {
...
BoundedOption<unsigned, 0, 16> mod_add_long_namespace_closebrace_comment = {
...
BoundedOption<unsigned, 0, 16> mod_add_long_class_closebrace_comment = {
...
BoundedOption<unsigned, 0, 50> mod_add_long_switch_closebrace_comment = {
...
BoundedOption<unsigned, 0, 16> mod_add_long_ifdef_endif_comment = {
...
BoundedOption<unsigned, 0, 16> mod_add_long_ifdef_else_comment = {
...
Spacing options
  ...
  register_option(&options::sp_cpp_lambda_paren);
  ...
  register_option(&options::sp_type_question);
  ...
  register_option(&options::sp_word_brace);
  ...
  register_option(&options::sp_before_tr_emb_cmt);
  register_option(&options::sp_num_before_tr_emb_cmt);
...
Indenting options
  ...
  register_option(&options::indent_sing_line_comments);
...
Blank line options
  ...
  register_option(&options::nl_func_var_def_blk);
...
Preprocessor options
  ...
  register_option(&options::pp_space);
